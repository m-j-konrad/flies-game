...
cfg_killer_messages       = ["Jo!\nIm Spiel geht es darum, NICHT die Schmetterlinge zu töten!!",
                             "Du würdest wohl auch\nkleine Kinder erschlagen,\nwas?",
                             "Mögen dich nachts Schmetterlinge besuchen...\nViele, viele Schmetterlinge...\nUnd dann ist Zeit für Vergeltung!",
                             "WIe kannst du sowas nur tun?!\nDas ist einfach unmenschlich! \U0001F928",
                             "Pah, du magst das wohl.",
                             "Die armen, armen Schmetterlinge. \U0001F614"]
                             
msg_window_title = "Fliegen!"
msg_welcome      = "Da sind wir.\nDu hast\n" + str(cfg_countdown) + " Sekunden, um so viele Fliegen wie möglich zu erschlagen.\n...Ich sagte »Fliegen«! \N{winking face}"
msg_info         = "Willkommen bei »Fliegen!«\nEin kleines Spiel geschrieben\n2022 von M. J. Konrad\nEs ist Open Source (frei) und - wie ich finde - gut kommentiert,\nalso fühl' dich frei zu tun, was immer du willst! :-)"

# header, where the stats are shown
msg_header_time_left               = "ZEIT: "
msg_header_seconds_left            = "s ÜBRIG. "
msg_header_killed_flies            = " GETÖTETE FLIEGEN. "
msg_header_level                   = "Level:"
msg_header_killed_no_butterfly     = " KEINE SCHMETTERLINGE GETÖTET! \U0001F642"
msg_header_killed_one_butterfly    = " EIN SCHMETTERLING TOT! \U0001F633"
msg_header_killed_few_butterflies  = " SCHMETTERLINGE GETÖTET! \U0001F928"
msg_header_killed_many_butterflies = " SCHMETTERLINGE GETÖTET!! \N{disappointed face}"

msg_dont_kill_butterflies  = "AUA!!\nKeine Schmetterlinge töten!\n"
msg_penalty_time           = " Sekunden Strafzeit!\n"
msg_hurry_up               = "Was?! Komm schon, beeil dich!!"
msg_timeout                = "Die Zeit ist abgelaufen!\n\n"
msg_killed_no_butterfly    = "Du hast keinen einzigen Schmeterling getötet!\nMögen die Schmetterlinge mit dir sein. \U0001F60C\n\n"
msg_killed_few_butterflies = "Du hast nicht so viele Schmetterlinge getötet!\nDas waren nur Unfälle, richtig?\n\n"
msg_butterfly_murderer     = "Du ist ein verdammter Schmetterlingsmörder!\nSchande über dich!! Ich hoffe, du wirst Alpträume haben. \U0001F614\n\n"
msg_num_flies_killed       = " Fliegen getötet, das sind\n"
msg_kills_per_minute       = "\ntote Fliegen pro Minute.\n\n\n...aber naja...\nAm Ende gewinnen eh die Fliegen. \U0001F60C"
msg_fly_enthusiast         = "Du liebst wohl Fliegen!\nDu hast keine einzige Fliege getötet.\nDas hier ist nicht Fernsehen.\nDu musst selber spielen..."

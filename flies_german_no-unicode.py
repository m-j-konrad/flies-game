...
cfg_killer_messages       = ["Jo!\nIm Spiel geht es darum, NICHT die Schmetterlinge zu töten!!",
                             ...
                             "Die armen, armen Schmetterlinge."]
...
msg_header_killed_no_butterfly     = " KEINE SCHMETTERLINGE GETÖTET! :-)"
msg_header_killed_one_butterfly    = " EIN SCHMETTERLING TOT! :-|"
msg_header_killed_few_butterflies  = " SCHMETTERLINGE GETÖTET! D-:"
msg_header_killed_many_butterflies = " SCHMETTERLINGE GETÖTET!! :-("
...
class Flies(tk.Tk):
	...
	def __init__(self):
		...
		self.obj_countdown_text = self.canvas.create_text(
		  10, 12, text="", fill="green", anchor=NW, font=('Helvetica','14','bold'))
